...
script_dir = Path(__file__).resolve().parent  # project/baselines/fine-tuning
project_root = script_dir.parent.parent       # project/
sys.path.insert(0, str(project_root))
from baselines.utils.utils import load_config, Instructions, Instructions_summary, \
...
SUMMARIZATION_DATASETS = {'openai/summarize_from_feedback'}
...
class ScriptArguments:
    ...
    dataset_name: Optional[str] = field(default='Anthropic/hh-rlhf', metadata={"help": "dataset: 'Anthropic/hh-rlhf', 'openai/summarize_from_feedback', 'PKU-Alignment/PKU-SafeRLHF-10K'"})
    reward_name: Optional[str] = field(default='harmless', metadata={"help": "the reward model name: 'summary', 'faithful', 'helpful', 'harmless', 'deberta', 'humor', 'beaver_reward', 'beaver_cost'"})
