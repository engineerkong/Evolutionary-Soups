...
script_dir = Path(__file__).resolve().parent          # .../Evolutionary_Soups/baselines/hoe
project_root = script_dir.parent.parent               # .../Evolutionary_Soups
workspace_root = project_root.parent                  # .../Evolutionary_Soups (contains anonymous-repo-for-HoE)
...
from baselines.hoe.hoe_architecture import ConditionedMOEModelWithValueHead, WeightSampler
from baselines.hoe.hoe_utils import (
    build_hoe_model,
    clean_response,
    load_router_weights,
...
class ScriptArguments:
    ...
    dataset_name: str = field(default='Anthropic/hh-rlhf', metadata={'help': 'Dataset: Anthropic/hh-rlhf, openai/summarize_from_feedback, PKU-Alignment/PKU-SafeRLHF-10K'})
...
_long_response_datasets = {'Anthropic/hh-rlhf', 'PKU-Alignment/PKU-SafeRLHF-10K'}
generation_kwargs = {
