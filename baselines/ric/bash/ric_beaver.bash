...
# Run from MOMoE/ directory: bash baselines/ric/bash/ric_beaver.bash
set -e
...
# python ./baselines/ric/prepare_dataset.py \
...
python ./baselines/ric/evaluation.py \
    --base_model_name "${base_model_name}" \
