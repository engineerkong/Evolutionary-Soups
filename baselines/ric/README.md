...
| Task | Script |
|------|--------|
| Assistant (harmless, helpful, humor) | `bash baselines/ric/bash/ric_assistant.bash` |
| Summary (summary, faithful, deberta) | `bash baselines/ric/bash/ric_summary.bash` |
| Beaver (beaver_reward, beaver_cost) | `bash baselines/ric/bash/ric_beaver.bash` |
...
```bash
CUDA_VISIBLE_DEVICES=0 python ./baselines/ric/prepare_dataset.py \
