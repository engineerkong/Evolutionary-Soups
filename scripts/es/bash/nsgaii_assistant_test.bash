...
gating_paths='./models/ES/es_assistant_1705/gen_0110'
dataset_name='Anthropic/hh-rlhf'
reward_names='harmless,helpful,humor'
eval_prompts=0
pref_step=0.2
run_name='es_assistant_test_gen110_1705'

mkdir -p ./logs

PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True \
CUDA_VISIBLE_DEVICES=2,3 accelerate launch --main_process_port 29601 \
