...
gating_paths="./models/ES_refined/es_refined_beaver_2505/refined"
...
eval_prompts=0
pref_step=0.1
run_name='es_beaver_refined500_test_2505'

PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True \
CUDA_VISIBLE_DEVICES=0,1,6,7 accelerate launch --main_process_port 29904 \
